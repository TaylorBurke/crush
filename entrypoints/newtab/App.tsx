    ...
    <div className="flex h-screen bg-[radial-gradient(ellipse_at_center,var(--color-bg-gradient-from),var(--color-bg-gradient-to))]">
      ...
      {!chatOpen && settings.bookmarks.length > 0 && (
        <button
          ...
          className={`fixed bottom-[5.125rem] left-4 z-30 flex w-12 items-center justify-center rounded-full p-1 text-text-muted transition-all ${settings.showBookmarks ? '' : 'opacity-0 hover:opacity-100 focus:opacity-100'}`}
