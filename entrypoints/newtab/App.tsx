    ...
    <div className="flex h-screen bg-[radial-gradient(ellipse_at_center,var(--color-bg-gradient-from),var(--color-bg-gradient-to))]">
      ...
      {!chatOpen && settings.bookmarks.length > 0 && (
        <button
          ...
          className="fixed bottom-[3.25rem] left-4 z-30 flex w-10 items-center justify-center rounded-full p-1 text-text-muted opacity-0 transition-all hover:opacity-100 focus:opacity-100"
